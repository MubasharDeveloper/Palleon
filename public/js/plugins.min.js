/* IsInViewPort */
function run(e) {
    if (1 === arguments.length && "function" == typeof e && (e = [e]),
    !(e instanceof Array))
    ...
    return e.forEach(t => {
        ...
        console.warn("isInViewport: Ignoring non-function values in array and moving on")) : [].slice.call(this).forEach(e => t.call($(e)))
    }
    ),
    this
}
...
function isInViewport(e, t) {
    ...
    c.length || (console.warn("isInViewport: The viewport selector you have provided matches no element on page."),
    console.warn("isInViewport: Defaulting to viewport as window"),
    c = $(window));
    e = c.height();
    let l = c.width();
    t = c[0].toString();
    return c[0] !== window && "[object Window]" !== t && "[object DOMWindow]" !== t && (t = c[0].getBoundingClientRect(),
    o -= t.top,
    n -= t.top,
    r -= t.left,
    i -= t.left,
    isInViewport.scrollBarWidth = isInViewport.scrollBarWidth || getScrollbarWidth(c),
    l -= isInViewport.scrollBarWidth),
...
function getSelectorArgs(e) {
    if (e) {
        const t = e.split(",");
        return 1 === t.length && isNaN(t[0]) && (t[1] = t[0],
        t[0] = void 0),
        {
...
!function(n, e) {
    ...
    var H = function(b, e, M, t) {
        ...
        function r(n) {
            ...
            if (0 === a)
                return r;
            for (var l, d, p = n, h = e, g = e + .1, m = b, v = M, y = 0; 0 < (l = k(d = h + (g - h) / 2, m, v) - p) ? g = d : h = d,
    ...
    function V(n) {
        ...
        "rgba(" + parseInt(e[1], 16) + "," + parseInt(e[2], 16) + "," + parseInt(e[3], 16) + ",1)") : w.hsl(n) ? (t = /hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec(t = n) || /hsla\((\d+),\s*([\d.]+)%,\s*([\d.]+)%,\s*([\d.]+)\)/g.exec(t),
        n = parseInt(t[1], 10) / 360,
        u = parseInt(t[2], 10) / 100,
        i = parseInt(t[3], 10) / 100,
        t = t[4] || 1,
        0 == u ? r = a = o = i : (r = c(u = 2 * i - (i = i < .5 ? i * (1 + u) : i + u - i * u), i, n + 1 / 3),
        a = c(u, i, n),
        o = c(u, i, n - 1 / 3)),
    ...
    function y(n, e, t) {
        var r, a, o;
        return h([t, "deg", "rad", "turn"], B(e)) ? e : (r = l.CSS[e + t],
        w.und(r) ? (a = document.createElement(n.tagName),
    ...
    function X(n, e, t, r) {
        var a = u(e, "scale") ? 1 : 0 + (u(a = e, "translate") || "perspective" === a ? "px" : u(a, "rotate") || u(a, "skew") ? "deg" : void 0)
          , o = W(n).get(e) || a;
        return t && (t.transforms.list.set(e, o),
        t.transforms.last = e),
        r ? y(n, o, r) : o
    }
    function T(n, e, t, r) {
    ...
    function Y(n, e) {
        var t;
        return w.col(n) ? V(n) : /\s/g.test(n) ? n : (t = (t = B(n)) ? n.substr(0, n.length - t.length) : n,
        e ? t + e : t)
    }
    function F(n, e) {
    ...
    function J(n, e) {
        ...
        for (t in e = a ? D(R(a), e) : e)
            w.key(t) && r.push({
                name: t,
                tweens: function(n, t) {
                    var e, r = g(t), a = (/^spring/.test(r.easing) && (r.duration = c(r.easing)),
                    w.arr(n) && (2 === (e = n.length) && !w.obj(n[0]) ? n = {
                        value: n
    ...
    function L(n) {
        ...
        function y(e) {
            for (var n = 0, t = k.animations, r = t.length; n < r; ) {
                ...
                C(e - c.start - c.delay, 0, c.duration) / c.duration), s = isNaN(i) ? 1 : c.easing(i), f = c.to.strings, l = c.round, d = [], p = c.to.numbers.length, h = void 0, g = 0; g < p; g++) {
                    var m = void 0
                      , v = c.to.numbers[g]
        ...
        function u(n) {
            ...
            b("changeBegin")),
            b("change"),
            y(a)) : k.changeBegan && (k.changeCompleted = !0,
            k.changeBegan = !1,
            b("changeComplete")),
            ...
            b("loopComplete"),
            k.loopBegan = !1,
            "alternate" === k.direction && g()) : (k.paused = !0,
            k.completed || (k.completed = !0,
            b("loopComplete"),
            b("complete"),
            !k.passThrough && "Promise"in window && (p(),
            h(k)))))
        }
            ...
            _keyboard(t) {
                ...
                if (document.activeElement === o.wrapper) {
                    ...
                    if ("keydown" === n && (s || r || a || l)) {
                        ...
                        n = l ? -1 : r ? 1 : 0),
                        e.update($(e.cache.x + .01 * n), $(e.cache.y + .01 * i)),
                        t.preventDefault()
                    } else
      ...
      , O = (t, e, o) => {
        ...
        return {
            update(t=n) {
                ...
                return ( (t, e, o) => {
                    const {container: n, arrow: i, margin: s, padding: r, position: a, variantFlipOrder: l, positionFlipOrder: c} = {
...
!function(t, e) {
    ...
    class SelectionArea extends class {
        ...
        addEventListener(t, e) {
            ...
            return this.t.set(t, s),
            s.add(e),
            this
        }
        removeEventListener(t, e) {
            return this.t.get(t)?.delete(e),
            this
        }
        dispatchEvent(t, ...e) {
            let s = !0;
    ...
    }
    {
        ...
        g(t=!0) {
            const {document: e, allowTouch: s} = this._
              , n = t ? i : o;
            n(e, "mousedown", this.A),
            s && n(e, "touchstart", this.A, {
                passive: !1
            })
        }
        A(t, e=!1) {
            ...
            const m = h(t);
            if (!this.L || !p.find((t => m.includes(t))) || !f.find((t => m.includes(t))))
                return;
            if (!e && !1 === this.k("beforestart", t))
                return;
            this.l = {
                x1: s,
                y1: o,
            ...
            i(d, ["touchmove", "mousemove"], this.j, {
                passive: !1
            }),
            i(d, ["mouseup", "touchcancel", "touchend"], this.M),
            i(d, "scroll", this.O)
        }
        R(t) {
            ...
            t.shiftKey && o.length) {
                ...
                o.includes(i) && (1 === o.length || t.ctrlKey) ? this.deselect(i) : this.select(i);
            this.k("stop", t)
        }
        j(t) {
            const {startThreshold: s, container: h, document: r, allowTouch: c} = this._
              ...
              , {x: f, y: m} = n(t)
              , v = typeof s;
            ("number" === v && d(f + m - (u + p)) >= s || "object" === v && d(f - u) >= s.x || d(m - p) >= s.y) && (o(r, ["mousemove", "touchmove"], this.j, {
                passive: !1
            }),
            i(r, ["mousemove", "touchmove"], this.$, {
                passive: !1
            }),
            ...
            this.p && (i(r, "wheel", this.D, {
                passive: !1
            }),
            this.o = this.o.filter((t => this.L.contains(t)))),
            this.H(),
            this.k("start", t),
            this.$(t)),
        ...
        $(t) {
            ...
            this.p && (i.y || i.x)) {
                const e = () => {
                    ...
                    i.y && (l.scrollTop += f(i.y / c),
                    o.y1 -= l.scrollTop - s),
                    i.x && (l.scrollLeft += f(i.x / c),
                    o.x1 -= l.scrollLeft - n),
                    this.q(),
                    this.F(),
                    this.k("move", t),
        ...
        q() {
            ...
            g < f.left ? (t.x = c ? -d(f.left - g) : 0,
            g = f.left) : g > f.right ? (t.x = l - c - a ? d(f.left + f.width - g) : 0,
            g = f.right) : t.x = 0,
            y < f.top ? (t.y = n ? -d(f.top - y) : 0,
            y = f.top) : y > f.bottom ? (t.y = h - n - r ? d(f.top + f.height - y) : 0,
            y = f.bottom) : t.y = 0;
            const _ = p(m, g)
              , w = p(v, y)
              , x = u(m, g)
        ...
        M(t, s) {
            ...
            o(i, "scroll", this.O),
            t && h && n.allow ? this.R(t) : h || s || (this.F(),
            this.k("stop", t)),
            this.m.x = 0,
            this.m.y = 0,
            this.p && o(i, "wheel", this.D, {
                passive: !0
            }),
            this.T.remove(),
        ...
        F() {
            ...
            for (let e = 0; e < t.length; e++) {
                ...
                if (r(i, s.getBoundingClientRect(), c)) {
                    if (n.includes(s))
                        o.includes(s) && !h.includes(s) && h.push(s);
                    else {
        ...
        deselect(t, e=!1) {
            ...
            return !(!s.includes(t) && !i.includes(t)) && (o.removed.push(t),
            c(i, t),
            c(s, t),
            !e && this.k("move", null),
            !0)
    ...
    return SelectionArea.version = "2.1.1",
    SelectionArea
}
));
...
!function(t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).Localbase = t()
}(function() {
    return function n(o, i, u) {
        ...
        1: [function(t, e, r) {
            ...
            r.default = void 0;
            var o = ((n = t("./localbase/localbase")) && n.__esModule ? n : {
                default: n
            }).default;
            r.default = o,
            e.exports = r.default
        ...
        5: [function(t, e, r) {
            ...
            r.default = function() {
                for (var t = 0; t < this.userErrors.length; t++)
                    n.default.error.call(this, this.userErrors[t]);
                o.default.call(this)
            }
            ;
            var n = i(t("../utils/logger"))
        ...
        6: [function(t, e, r) {
            ...
            r.default = function(t, e) {
                return o.default.call(this),
                n.default.log.call(this, t, e),
                "Success: ".concat(t, " ").concat(JSON.stringify(e))
            }
            ;
            var n = i(t("../utils/logger"))
              , o = i(t("../api-utils/reset"));
        ...
        7: [function(t, e, r) {
            ...
            r.default = function(n, o) {
                var i = this;
                n ? "object" == f(n) && n instanceof Array == 0 || this.userErrors.push("Data passed to .add() must be an object. Not an array, string, number or boolean.") : this.userErrors.push('No data specified in add() method. You must use an object, e.g { id: 1, name: "Bill", age: 47 }');
                {
                    if (!this.userErrors.length) {
                        ...
                        return new Promise(function(t, e) {
                            var r = null
                              , r = o || l.generate();
                            return i.lf[u].setItem(r, n).then(function() {
                                t(a.default.call(i, 'Document added to "'.concat(u, '" collection:'), {
                                    key: r,
                                    data: n
                                }))
                            }).catch(function(t) {
        ...
        8: [function(t, e, r) {
            ...
            r.default = function() {
                ...
                return new Promise(function(i, u) {
                    if (a.deleteDatabase = function() {
                        var t = a.dbName;
                        indexedDB.deleteDatabase(t),
                        i(f.default.call(a, 'Database "'.concat(t, '" deleted.')))
                    }
                    ,
                    a.deleteCollection = function() {
                        ...
                        a.addToDeleteCollectionQueue = function(t) {
                            a.deleteCollectionQueue.queue.push(t),
                            a.runDeleteCollectionQueue()
                        }
                        ,
                        a.runDeleteCollectionQueue = function() {
                            0 == a.deleteCollectionQueue.running && (a.deleteCollectionQueue.running = !0,
                            a.deleteNextCollectionFromQueue())
                        }
                        ,
                        a.deleteNextCollectionFromQueue = function() {
                            var e;
                            a.deleteCollectionQueue.queue.length ? (e = a.deleteCollectionQueue.queue[0],
                            ...
                            a.lf[e].dropInstance({
                                ...
                                a.deleteNextCollectionFromQueue(),
                                i(f.default.call(a, 'Collection "'.concat(e, '" deleted.')))
                            }).catch(function(t) {
                    ...
                    a.deleteDocument = function() {
                        ...
                        return a.deleteDocumentByCriteria = function() {
                            var r = [];
                            a.lf[n].iterate(function(t, e) {
                                (0,
                                c.default)(t, o) && r.push(e)
                            }).then(function() {
                                ...
                                r.forEach(function(t, e) {
                                    a.lf[n].removeItem(t).then(function() {
                                        e === r.length - 1 && i(f.default.call(a, "".concat(r.length, " Document").concat(1 < r.length ? "s" : "", " with ").concat(JSON.stringify(o), " deleted.")))
                                    }).catch(function(t) {
                        ...
                        a.deleteDocumentByKey = function() {
                            a.lf[n].getItem(o).then(function(t) {
                                t ? a.lf[n].removeItem(o).then(function() {
            ...
            r.default = function() {
                ...
                this.getCollection = function() {
                    var e = u.collectionName
                      ...
                      , o = u.limitBy
                      , i = [];
                    return u.lf[e].iterate(function(t, e) {
                        var r = {}
                          , r = a.keys ? {
                            key: e,
                            data: t
                        ...
                        return r && (t += ', ordered by "'.concat(r, '"'),
                        a.keys ? i.sort(function(t, e) {
                ...
                this.getDocument = function() {
                    var e = u.collectionName
                      ...
                      , n = []
                      , o = {};
                    return u.getDocumentByCriteria = function() {
                        return u.lf[e].iterate(function(t, e) {
                            (0,
                            i.default)(t, r) && n.push(t)
                        }).then(function() {
                            return n.length ? (o = n[0],
                            c.default.log.call(u, "Got Document with ".concat(JSON.stringify(r), ":"), o),
                            s.default.call(u),
                            o) : void c.default.error.call(u, 'Could not find Document in "'.concat(e, '" collection with criteria: ').concat(JSON.stringify(r)))
                        })
                    }
                    ,
                    u.getDocumentByKey = function() {
                        return u.lf[e].getItem(r).then(function(t) {
                            return (o = t) ? c.default.log.call(u, "Got Document with key ".concat(JSON.stringify(r), ":"), o) : c.default.error.call(u, 'Could not find Document in "'.concat(e, '" collection with Key: ').concat(JSON.stringify(r))),
                            s.default.call(u),
                            o
                        }).catch(function(t) {
        ...
        10: [function(t, e, r) {
            ...
            r.default = function(i) {
                ...
                return new Promise(function(n, o) {
                    if (u.setDocumentByCriteria = function() {
                        var r = [];
                        u.lf[a].iterate(function(t, e) {
                            (0,
                            f.default)(t, c) && r.push({
                                key: e,
                                newDocument: i
                            })
                        }).then(function() {
                            ...
                            r.forEach(function(t, e) {
                                u.lf[a].setItem(t.key, t.newDocument).then(function(t) {
                                    e === r.length - 1 && n(l.default.call(u, "".concat(r.length, " Document").concat(1 < r.length ? "s" : "", ' in "').concat(a, '" collection with ').concat(JSON.stringify(c), " set to:"), i))
                                }).catch(function(t) {
                    ...
                    u.setDocumentByKey = function() {
                        u.lf[a].setItem(c, i).then(function(t) {
                    ...
                    ,
                    i ? "object" == p(i) && i instanceof Array == 0 || u.userErrors.push("Data passed to .set() must be an object. Not an array, string, number or boolean.") : u.userErrors.push('No new Document object provided to set() method. Use an object e.g. { id: 1, name: "Bill", age: 47 }'),
                    !u.userErrors.length)
                ...
                return new Promise(function(n, o) {
                    u.updateDocumentByCriteria = function() {
                        ...
                        u.lf[a].iterate(function(t, e) {
                            ...
                            r.forEach(function(t, e) {
                                u.lf[a].setItem(t.key, t.newDocument).then(function(t) {
                                    e === r.length - 1 && n(d.default.call(u, "".concat(r.length, " Document").concat(1 < r.length ? "s" : "", ' in "').concat(a, '" collection with ').concat(JSON.stringify(c), " updated with:"), i))
                                }).catch(function(t) {
                    ...
                    u.updateDocumentByKey = function() {
                        var e;
                        u.lf[a].getItem(c).then(function(t) {
                            e = (0,
                            l.default)(t, i),
                            u.lf[a].setItem(c, e),
                            n(d.default.call(u, 'Document in "'.concat(a, '" collection with key ').concat(JSON.stringify(c), " updated to:"), e))
                        }).catch(function(t) {
                            o(h.default.call(u, 'No Document found in "'.concat(a, '" collection with key ').concat(JSON.stringify(c))))
                        })
                    }
                    ,
                    i ? "object" == y(i) && i instanceof Array == 0 || u.userErrors.push("Data passed to .update() must be an object. Not an array, string, number or boolean.") : u.userErrors.push('No update object provided to update() method. Use an object e.g. { name: "William" }'),
        ...
        12: [function(t, e, r) {
            ...
            r.default = function(t) {
                t ? Number.isInteger(t) ? this.limitBy = t : this.userErrors.push("Limit parameter in limit() method must be an integer (e.g. 3) and not a float, boolean, string or object.") : this.userErrors.push("No integer specified in limit() method.");
                return this
            }
            ,
            e.exports = r.default
        ...
        13: [function(t, e, r) {
            ...
            r.default = function(t, e) {
                t ? "string" != typeof t ? this.userErrors.push("First parameter in orderBy() method must be a string (a field name) e.g. 'name'") : this.orderByProperty = t : this.userErrors.push("No field name specified in orderBy() method. Use a string e.g. 'name'");
            ...
            r.default = function(t) {
                {
                    if (t) {
                        if ("string" != typeof t)
                            return this.userErrors.push("Collection name in collection() method must be a string and not an object, number or boolean."),
                            this;
                    ...
                    return this.userErrors.push("No collection name specified in collection() method."),
                    this
                }
            }
            ;
            var n, o = (n = t("localforage")) && n.__esModule ? n : {
                default: n
            };
            e.exports = r.default
        }
        ...
        18: [function(t, e, r) {
            ...
            var n = {
                ...
                log: function(t, e) {
                    var r;
                    this.config.debug && (r = n.baseStyle + "background-color: ".concat(n.colors.log),
                    e ? console.log("%clocalbase", r, t, e) : console.log("%clocalbase", r, t))
                },
                error: function(t, e) {
                    var r;
                    this.config.debug && (r = n.baseStyle + "background-color: ".concat(n.colors.error),
                    console.error("%clocalbase", r, t))
                },
                warn: function(t, e) {
                    var r;
                    this.config.debug && (r = n.baseStyle + "background-color: ".concat(n.colors.warn),
                    console.warn("%clocalbase", r, t))
                }
            };
            r.default = n,
            e.exports = r.default
                    ...
                    return function n(o, i, u) {
                        function a(r, t) {
                            if (!i[r]) {
                                ...
                                o[r][0].call(e.exports, function(t) {
                                    var e = o[r][1][t];
                                    return a(e || t)
                                }, e, e.exports, n, o, i, u)
                            }
                        ...
                        for (var c = "function" == typeof s && s, t = 0; t < u.length; t++)
                            a(u[t]);
                        return a
                    }({
                        1: [function(t, s, e) {
                            (function(e) {
                                "use strict";
                                var t, r, n, o, i = e.MutationObserver || e.WebKitMutationObserver, u = i ? (t = 0,
                                i = new i(c),
                        ...
                        2: [function(t, e, r) {
                            ...
                            a.prototype.then = function(t, e) {
                                if ("function" != typeof t && this.state === u || "function" != typeof e && this.state === i)
                                    return this;
                                var r = new this.constructor(c);
                                return this.state !== n ? l(r, this.state === u ? t : e, this.outcome) : this.queue.push(new f(r,t,e)),
                                r
                            }
                            ,
                            ...
                            s.resolve = function(t, e) {
                                ...
                                if (r)
                                    ...
                                    t.state = u,
                                    t.outcome = e;
                                    for (var n = -1, o = t.queue.length; ++n < o; )
                        ...
                        4: [function(t, e, r) {
                            ...
                            var u = "local-forage-detect-blob-support"
                              ...
                              , g = "readwrite";
                            function v(t) {
                                return "boolean" == typeof o ? f.resolve(o) : (n = t,
                                new f(function(r) {
                            ...
                            function _(o, i) {
                                return new f(function(t, e) {
                                    ...
                                    i && (n.onupgradeneeded = function(e) {
                                        var t = n.result;
                                        try {
                                            t.createObjectStore(o.storeName),
                                            e.oldVersion <= 1 && t.createObjectStore(u)
                                        } catch (t) {
                                            if ("ConstraintError" !== t.name)
                                                throw t;
                                            console.warn('The database "' + o.name + '" has been upgraded from version ' + e.oldVersion + " to version " + e.newVersion + ', but the storage "' + o.storeName + '" already exists.')
                                        }
                                    }
                                    ),
                            ...
                            function I(t, e) {
                                ...
                                return n && (t.version !== e && console.warn('The database "' + t.name + "\" can't be downgraded from version " + t.db.version + " to version " + t.version + "."),
                                t.version = t.db.version),
                                (o || r) && (!r || (r = t.db.version + 1) > t.version && (t.version = r),
                                1)
                            }
                            function N(t) {
                                return i([function(t) {
                                    for (var e = t.length, r = new ArrayBuffer(e), n = new Uint8Array(r), o = 0; o < e; o++)
                                        n[o] = t.charCodeAt(o);
                                    return r
                                }(atob(t.data))], {
                                    type: t.type
                                ...
                                try {
                                    ...
                                    if (0 < o && (!e.db || "InvalidStateError" === t.name || "NotFoundError" === t.name))
                                        return f.resolve().then(function() {
                                            if (!e.db || "NotFoundError" === t.name && !e.db.objectStoreNames.contains(e.storeName) && e.version <= e.db.version)
                            ...
                            var j = {
                                ...
                                _initStorage: function(t) {
                                    ...
                                    return f.all(r).then(function() {
                                        return o.db = i.db,
                                        S(o)
                                    }).then(function(t) {
                                        return o.db = t,
                                        I(o, n._defaultConfig.version) ? E(o) : t
                                    }).then(function(t) {
                                        o.db = i.db = t,
                                        n._dbInfo = o;
                                        for (var e = 0; e < s.length; e++) {
                                            var r = s[e];
                                            r !== n && (r._dbInfo.db = o.db,
                                            r._dbInfo.version = o.version)
                                        }
                                    })
                                },
                                _support: function() {
                                            ...
                                            A(a._dbInfo, y, function(t, e) {
                                                ...
                                                try {
                                                    ...
                                                    r.onsuccess = function() {
                                                        var t, e = r.result;
                                                        e ? (B(t = e.value) && (t = N(t)),
                                                        void 0 !== (t = u(t, e.key, n++)) ? o(t) : e.continue()) : o()
                                                    }
                                                    ,
                                                    r.onerror = function() {
                                                        i(r.error)
                                ...
                                setItem: function(a, e, t) {
                                    ...
                                    var r = new f(function(i, u) {
                                        ...
                                        c.ready().then(function() {
                                            return t = c._dbInfo,
                                            "[object Blob]" === p.call(e) ? v(t.db).then(function(t) {
                                                return t ? e : (n = e,
                                                new f(function(e, t) {
                                ...
                                key: function(a, t) {
                                    var c = this
                                      , e = new f(function(i, u) {
                                        a < 0 ? i(null) : c.ready().then(function() {
                                ...
                                dropInstance: function(u, t) {
                                    ...
                                    var e, r = this.config();
                                    return (u = "function" != typeof u && u || {}).name || (u.name = u.name || r.name,
                                    u.storeName = u.storeName || r.storeName),
                                    l(e = u.name ? (e = u.name === r.name && this._dbInfo.db ? f.resolve(this._dbInfo.db) : S(u).then(function(t) {
                                        var e = h[u.name]
                                          , r = e.forages;
                                        e.db = t;
                                    ...
                                    u.storeName ? e.then(function(t) {
                                        if (t.objectStoreNames.contains(u.storeName)) {
                                            ...
                                            return new f(function(e, r) {
                                                ...
                                                throw (w(u, t) || f.resolve()).catch(function() {}),
                                                t
                                            })
                                        }
                                    }) : e.then(function(t) {
                            ...
                            function P(t) {
                                var e, r, n, o, i = .75 * t.length, u = t.length, a = 0;
                                "=" === t[t.length - 1] && (i--,
                                "=" === t[t.length - 2] && i--);
                            ...
                            function F(t) {
                                for (var e = new Uint8Array(t), r = "", n = 0; n < e.length; n += 3)
                                    r += O[e[n] >> 2],
                                    r += O[(3 & e[n]) << 4 | e[n + 1] >> 4],
                                    r += O[(15 & e[n + 1]) << 2 | e[n + 2] >> 6],
                                    r += O[63 & e[n + 2]];
                                return e.length % 3 == 2 ? r = r.substring(0, r.length - 1) + "=" : e.length % 3 == 1 && (r = r.substring(0, r.length - 2) + "=="),
                                r
                            }
                            var z = {
                                serialize: function(e, r) {
                                    var t = "";
                                    if (e && (t = L.call(e)),
                                    e && ("[object ArrayBuffer]" === t || e.buffer && "[object ArrayBuffer]" === L.call(e.buffer))) {
                                        var n, o = k;
                                        e instanceof ArrayBuffer ? (n = e,
                                        o += M) : (n = e.buffer,
                                        "[object Int8Array]" === t ? o += "si08" : "[object Uint8Array]" === t ? o += "ui08" : "[object Uint8ClampedArray]" === t ? o += "uic8" : "[object Int16Array]" === t ? o += "si16" : "[object Uint16Array]" === t ? o += "ur16" : "[object Int32Array]" === t ? o += "si32" : "[object Uint32Array]" === t ? o += "ui32" : "[object Float32Array]" === t ? o += "fl32" : "[object Float64Array]" === t ? o += "fl64" : r(new Error("Failed to get type for BinaryArray"))),
                                        r(o + F(n))
                                ...
                                deserialize: function(t) {
                                    if (t.substring(0, R) !== k)
                                        return JSON.parse(t);
                                    var e, r = t.substring(U), n = t.substring(R, U);
                                    n === T && x.test(r) && (e = (t = r.match(x))[1],
                            ...
                            function J(t, n, o, i, u, a) {
                                t.executeSql(o, i, u, function(t, r) {
                                    r.code === r.SYNTAX_ERR ? t.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name = ?", [n.storeName], function(t, e) {
                                        e.rows.length ? a(t, r) : q(t, n, function() {
                                ...
                                var e = new f(function(o, i) {
                                    s.ready().then(function() {
                                        ...
                                        n.serializer.serialize(t, function(e, t) {
                                            t ? i(t) : n.db.transaction(function(t) {
                                                J(t, n, "INSERT OR REPLACE INTO " + n.storeName + " (key, value) VALUES (?, ?)", [u, e], function() {
                                                    o(r)
                                                }, function(t, e) {
                                                    i(e)
                                                })
                            ...
                            var W = {
                                    ...
                                    var r = new f(function(n, o) {
                                        i.ready().then(function() {
                                            ...
                                            r.db.transaction(function(t) {
                                                J(t, r, "SELECT * FROM " + r.storeName + " WHERE key = ? LIMIT 1", [e], function(t, e) {
                                    ...
                                    var e = new f(function(r, n) {
                                        i.ready().then(function() {
                                            ...
                                            e.db.transaction(function(t) {
                                                J(t, e, "DELETE FROM " + e.storeName + " WHERE key = ?", [o], function() {
                                                    r()
                                                }, function(t, e) {
                                                    n(e)
                                                })
                                    ...
                                    var o = this
                                      , e = new f(function(r, n) {
                                        o.ready().then(function() {
                                            var e = o._dbInfo;
                                            e.db.transaction(function(t) {
                                                J(t, e, "DELETE FROM " + e.storeName, [], function() {
                                                    r()
                                                }, function(t, e) {
                                                    n(e)
                                                })
                                    ...
                                    var o = this
                                      , e = new f(function(r, n) {
                                        o.ready().then(function() {
                                            var e = o._dbInfo;
                                            e.db.transaction(function(t) {
                                                J(t, e, "SELECT COUNT(key) as c FROM " + e.storeName, [], function(t, e) {
                                                    e = e.rows.item(0).c;
                                                    r(e)
                                                }, function(t, e) {
                                                    n(e)
                                    ...
                                    var i = this
                                      , e = new f(function(r, n) {
                                        i.ready().then(function() {
                                            var e = i._dbInfo;
                                            e.db.transaction(function(t) {
                                                J(t, e, "SELECT key FROM " + e.storeName + " WHERE id = ? LIMIT 1", [o + 1], function(t, e) {
                                    ...
                                    var n = this
                                      , e = new f(function(o, r) {
                                        n.ready().then(function() {
                                            var e = n._dbInfo;
                                            e.db.transaction(function(t) {
                                                J(t, e, "SELECT key FROM " + e.storeName, [], function(t, e) {
                                                    for (var r = [], n = 0; n < e.rows.length; n++)
                                                        r.push(e.rows.item(n).key);
                                                    o(r)
                                                }, function(t, e) {
                                                    r(e)
                                                })
                                ...
                                dropInstance: function(r, t) {
                                    t = s.apply(this, arguments);
                                    var n = this.config();
                                    (r = "function" != typeof r && r || {}).name || (r.name = r.name || n.name,
                                    r.storeName = r.storeName || n.storeName);
                                    var o = this
                                      , e = r.name ? new f(function(t) {
                                        var i, e = r.name === n.name ? o._dbInfo.db : openDatabase(r.name, "", "", 0);
                                        r.storeName ? t({
                                            db: e,
                            ...
                            function K(t, e) {
                                var r = t.name + "/";
                                return t.storeName !== e.storeName && (r += t.storeName + "/"),
                                r
                            }
                            function V() {
                                return !function() {
                            ...
                            function X(t, e) {
                                for (var r, n, o = t.length, i = 0; i < o; ) {
                                    if ((r = t[i]) === (n = e) || "number" == typeof r && "number" == typeof n && isNaN(r) && isNaN(n))
                                        return 1;
                                    i++
                                }
                            }
                            var t = {
                                ...
                                _initStorage: function(t) {
                                    ...
                                    if (t)
                                        for (var r in t)
                                            e[r] = t[r];
                                    return e.keyPrefix = K(t, this._defaultConfig),
                                    V() ? ((this._dbInfo = e).serializer = z,
                                    f.resolve()) : f.reject()
                                },
                                _support: function() {
                                    try {
                                      ...
                                      , e = s.ready().then(function() {
                                        for (var t = s._dbInfo, e = t.keyPrefix, r = e.length, n = localStorage.length, o = 1, i = 0; i < n; i++) {
                                            ...
                                            if (0 === u.indexOf(e)) {
                                                ...
                                                if (void 0 !== (a = c(a, u.substring(r), o++)))
                                                    return a
                                            }
                                        }
                                    });
                                        ...
                                        return new f(function(r, n) {
                                            ...
                                            o.serializer.serialize(t, function(t, e) {
                                                if (e)
                                                    ...
                                                    try {
                                                        localStorage.setItem(o.keyPrefix + u, t),
                                                        r(i)
                                                    } catch (t) {
                                                        "QuotaExceededError" !== t.name && "NS_ERROR_DOM_QUOTA_REACHED" !== t.name || n(t),
                                                        n(t)
                                                    }
                                            })
                                        }
                                ...
                                dropInstance: function(e, t) {
                                    t = s.apply(this, arguments),
                                    (e = "function" != typeof e && e || {}).name || (n = this.config(),
                                    e.name = e.name || n.name,
                                    e.storeName = e.storeName || n.storeName);
                                    var r = this
                                      , n = e.name ? new f(function(t) {
                            ...
                            function rt(t) {
                                for (var e = 1; e < arguments.length; e++) {
                                    ...
                                    if (r)
                                        for (var n in r)
                                            r.hasOwnProperty(n) && (Y(r[n]) ? t[n] = r[n].slice() : t[n] = r[n])
                                }
                                return t
                            }
                            function nt(t) {
                                ...
                                Z) {
                                    var r, n;
                                    Z.hasOwnProperty(e) && (n = (r = Z[e])._driver,
                                    this[e] = n,
                                    G[n] || this.defineDriver(r))
                                }
                                ...
                                var r = new f(function(e, r) {
                                    try {
                                        ...
                                        for (var o = tt.concat("_initStorage"), i = 0, u = o.length; i < u; i++) {
                                            var a = o[i];
                                            if ((!X($, a) || s[a]) && "function" != typeof s[a])
                                                return void r(t)
                                        }
                                        !function() {
                                        ...
                                        var c = function(t) {
                                            G[n] && console.info("Redefining LocalForage driver: " + n),
                                            G[n] = s,
                                            H[n] = t,
                                            e()
                                        };
                            ...
                            nt.prototype.setDriver = function(t, e, r) {
                                    ...
                                    return function() {
                                        ...
                                        return function t() {
                                            for (; n < o.length; ) {
                                                ...
                                                i._dbInfo = null,
                                                i._ready = null,
                                                i.getDriver(e).then(a).catch(t)
                                            }
                                            u();
                                            var r = new Error("No available storage method found.");
                                            return i._driverSet = f.reject(r),
                                            i._driverSet
                                        }()
                                    }
                                }
                                ...
                                return this._driverSet = t.then(function() {
                                    ...
                                    return i._driverSet = f.reject(t),
                                    i._driverSet
                                }),
        ...
        , {}],
        24: [function(t, e, r) {
            var n, o, i = "undefined" != typeof crypto && crypto.getRandomValues && crypto.getRandomValues.bind(crypto) || "undefined" != typeof msCrypto && "function" == typeof window.msCrypto.getRandomValues && msCrypto.getRandomValues.bind(msCrypto);
            i ? (n = new Uint8Array(16),
            e.exports = function() {
                return i(n),
                n
            }
        ...
        , {}],
        25: [function(t, e, r) {
            var f, l, d = t("./lib/rng"), h = t("./lib/bytesToUuid"), p = 0, y = 0;
            e.exports = function(t, e, r) {
                ...
                null != i && null != u || (c = d(),
                null == i && (i = f = [1 | c[0], c[1], c[2], c[3], c[4], c[5]]),
                null == u && (u = l = 16383 & (c[6] << 8 | c[7])));
                var a = void 0 !== t.msecs ? t.msecs : (new Date).getTime()
                  , r = void 0 !== t.nsecs ? t.nsecs : y + 1
                  , c = a - p + (r - y) / 1e4;
                if (c < 0 && void 0 === t.clockseq && (u = u + 1 & 16383),
                (c < 0 || p < a) && void 0 === t.nsecs && (r = 0),
                1e4 <= r)
        ...
        27: [function(t, e, r) {
            ...
            r.toByteArray = function(t) {
                var e, r, n = f(t), o = n[0], n = n[1], i = new s(function(t, e) {
                    return 3 * (t + e) / 4 - e
                }(o, n)), u = 0, a = 0 < n ? o - 4 : o;
                for (r = 0; r < a; r += 4)
                    e = c[t.charCodeAt(r)] << 18 | c[t.charCodeAt(r + 1)] << 12 | c[t.charCodeAt(r + 2)] << 6 | c[t.charCodeAt(r + 3)],
                    i[u++] = e >> 16 & 255,
                    i[u++] = e >> 8 & 255,
                    i[u++] = 255 & e;
                2 === n && (e = c[t.charCodeAt(r)] << 2 | c[t.charCodeAt(r + 1)] >> 4,
                i[u++] = 255 & e);
                1 === n && (e = c[t.charCodeAt(r)] << 10 | c[t.charCodeAt(r + 1)] << 4 | c[t.charCodeAt(r + 2)] >> 2,
                i[u++] = e >> 8 & 255,
                i[u++] = 255 & e);
                return i
            }
        ...
        28: [function(t, e, O) {
            (function(l) {
                ...
                function n(t, e, r) {
                    ...
                    if (D(t, ArrayBuffer) || t && D(t.buffer, ArrayBuffer))
                        return function(t, e, r) {
                            ...
                            return r.__proto__ = l.prototype,
                            r
                        }(t, e, r);
                    if ("number" == typeof t)
                    ...
                    n = function(t) {
                        ...
                        if (void 0 !== t.length)
                            return "number" != typeof t.length || j(t.length) ? o(0) : s(t);
                ...
                function s(t) {
                    for (var e = t.length < 0 ? 0 : 0 | f(t.length), r = o(e), n = 0; n < e; n += 1)
                        r[n] = 255 & t[n];
                    return r
                }
                function f(t) {
                ...
                function p(t, e, r, n, o) {
                    ...
                    if ("number" == typeof e)
                        return e &= 255,
                        "function" == typeof Uint8Array.prototype.indexOf ? (o ? Uint8Array.prototype.indexOf : Uint8Array.prototype.lastIndexOf).call(t, e, r) : y(t, [e], r, n, o);
                ...
                function b(t, e, r) {
                    r = Math.min(t.length, r);
                    for (var n = [], o = e; o < r; ) {
                        var i, u, a, c, s = t[o], f = null, l = 239 < s ? 4 : 223 < s ? 3 : 191 < s ? 2 : 1;
                        if (o + l <= r)
                            switch (l) {
                            case 1:
                                s < 128 && (f = s);
                            ...
                            case 3:
                                i = t[o + 1],
                                u = t[o + 2],
                                128 == (192 & i) && 128 == (192 & u) && 2047 < (c = (15 & s) << 12 | (63 & i) << 6 | 63 & u) && (c < 55296 || 57343 < c) && (f = c);
                                break;
                            case 4:
                                i = t[o + 1],
                                u = t[o + 2],
                ...
                l.alloc = function(t, e, r) {
                    ...
                    r = r,
                    u(t = t),
                    !(t <= 0) && void 0 !== e ? "string" == typeof r ? o(t).fill(e, r) : o(t).fill(e) : o(t)
                }
                ,
                l.allocUnsafe = c,
                l.allocUnsafeSlow = c,
                ...
                l.compare = function(t, e) {
                    if (D(t, Uint8Array) && (t = l.from(t, t.offset, t.byteLength)),
                ...
                l.prototype.writeIntLE = function(t, e, r, n) {
                    t = +t,
                    e >>>= 0,
                    n || _(this, t, e, r, (n = Math.pow(2, 8 * r - 1)) - 1, -n);
                    var o = 0
                      , i = 1
                      , u = 0;
        ...
        29: [function(t, e, r) {
            r.read = function(t, e, r, n, o) {
                var i, u, a = 8 * o - n - 1, c = (1 << a) - 1, s = c >> 1, f = -7, l = r ? o - 1 : 0, d = r ? -1 : 1, r = t[e + l];
                for (l += d,
                i = r & (1 << -f) - 1,
                r >>= -f,
                f += a; 0 < f; i = 256 * i + t[e + l],
                l += d,
                f -= 8)
                    ;
                for (u = i & (1 << -f) - 1,
                i >>= -f,
                f += n; 0 < f; u = 256 * u + t[e + l],
                l += d,
                f -= 8)
                    ;
                if (0 === i)
            ...
            r.write = function(t, e, r, n, o, i) {
                var u, a, c = 8 * i - o - 1, s = (1 << c) - 1, f = s >> 1, l = 23 === o ? Math.pow(2, -24) - Math.pow(2, -77) : 0, d = n ? 0 : i - 1, h = n ? 1 : -1, i = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
                for (e = Math.abs(e),
                isNaN(e) || e === 1 / 0 ? (a = isNaN(e) ? 1 : 0,
                u = s) : (u = Math.floor(Math.log(e) / Math.LN2),
                e * (n = Math.pow(2, -u)) < 1 && (u--,
                n *= 2),
                2 <= (e += 1 <= u + f ? l / n : l * Math.pow(2, 1 - f)) * n && (u++,
                n /= 2),
                s <= u + f ? (a = 0,
                u = s) : 1 <= u + f ? (a = (e * n - 1) * Math.pow(2, o),
                u += f) : (a = e * Math.pow(2, f - 1) * Math.pow(2, o),
                u = 0)); 8 <= o; t[r + d] = 255 & a,
                d += h,
                a /= 256,
                o -= 8)
...
!function(t, e) {
    ...
    function i(t, e) {
        var n, a = "LazyLoad::Initialized", o = new t(e);
        try {
            n = new CustomEvent(a,{
                detail: {
                    instance: o
    ...
    function x(t, e) {
        O(t, ct, l(t, e.data_sizes)),
        O(t, rt, l(t, e.data_srcset)),
    ...
    function G(t, e, n) {
        ...
        (a = at && r ? r : a) && (c.style.backgroundImage = 'url("'.concat(a, '")'),
        v(c).setAttribute(it, a),
        L(c, o, i)),
        r = n,
        o = l(a = t, (c = e).data_bg_multi),
        i = l(a, c.data_bg_multi_hidpi),
        (o = at && i ? i : o) && (a.style.backgroundImage = o,
        A(a, c, r)),
        c = n,
        (t = l(r = t, (n = e).data_bg_set)) && (t = (e = t.split("|")).map(function(t) {
            return "image-set(".concat(t, ")")
        }),
        r.style.backgroundImage = t.join(),
        "" === r.style.backgroundImage && (t = e.map(function(t) {
    ...
    function j(t, e, n) {
        ...
        a = e,
        e = n,
        (t = kt[(n = t).tagName]) && (t(n, a),
        L(n, a, e))
    }
    function D(t, e, n) {
        var a;
        a = t,
        (-1 < wt.indexOf(a.tagName) ? j : G)(t, e, n)
    }
    function H(t, e, n) {
        var a;
    ...
    function P(t, e, n, a) {
        var o;
        n.cancel_on_exit && (c(t) !== dt || "IMG" === t.tagName && (z(t),
        h(o = t, function(t) {
            V(t)
        }),
        V(o),
    ...
    function $(t, o, i) {
        t.forEach(function(t) {
            return (a = t).isIntersecting || 0 < a.intersectionRatio ? S(t.target, t, o, i) : (e = t.target,
            n = t,
            a = o,
            t = i,
    ...
    function q(e, n) {
        var t;
        et && !U(e) && (n._observer = new IntersectionObserver(function(t) {
            $(t, e, n)
        }
        ,{
    ...
    return t.prototype = {
        update: function(t) {
            var e, n, a, o = this._settings, i = X(t, o);
            {
                if (p(this, i.length),
                !tt && et)
                    return U(o) ? (e = o,
...
var sortable = function() {
    ...
    var v = function(e, t) {
        ...
        return "string" != typeof t ? Array.from(e) : Array.from(e).filter(function(e) {
      ...
      , t = function() {
        ...
        return Object.defineProperty(e.prototype, "config", {
            get: function() {
                var n = {};
                return this._config.forEach(function(e, t) {
                    n[t] = e
                }),
                n
            },
    ...
    var w = function(e) {
      ...
      , u = function(e, t, n) {
        var r;
        if (void 0 === n && (n = "sortable-placeholder"),
        !(e instanceof HTMLElement))
            throw new Error("You must provide a valid element as a sortable.");
        if (!(t instanceof HTMLElement) && void 0 !== t)
            throw new Error("You must provide a valid element as a placeholder or set ot to undefined.");
        return void 0 === t && (["UL", "OL"].includes(e.tagName) ? t = document.createElement("li") : ["TABLE", "TBODY"].includes(e.tagName) ? (t = document.createElement("tr")).innerHTML = '<td colspan="100"></td>' : t = document.createElement("div")),
      ...
      , L = function(e) {
        ...
        return "border-box" === n.getPropertyValue("box-sizing") ? parseInt(n.getPropertyValue("height"), 10) : ["height", "padding-top", "padding-bottom"].map(function(e) {
      ...
      , x = function(e) {
        if (!(e instanceof HTMLElement))
            throw new Error("You must provide a valid dom element");
        var n = window.getComputedStyle(e);
        return ["width", "padding-left", "padding-right"].map(function(e) {
            var t = parseInt(n.getPropertyValue(e), 10);
            return isNaN(t) ? 0 : t
        }).reduce(function(e, t) {
            return e + t
      ...
      , s = function(e, t) {
        ...
        return "string" != typeof t ? e : e.filter(function(e) {
      ...
      , D = function(e, t) {
        if (!0 === e.isSortable) {
            ...
            if (null !== n)
                return !1 !== n && 0 < n.split(",").filter(function(e) {
                    return 0 < e.length && t.matches(e)
                }).length;
            if (e === t)
                return !0;
            if (void 0 !== E(e).getConfig("connectWith") && null !== E(e).getConfig("connectWith"))
                return E(e).getConfig("connectWith") === E(t).getConfig("connectWith")
        }
        return !1
    }
      , M = {
    ...
    var H, I, A, S, Y, _, O, P, z, h = function(e, t) {
        if ("string" == typeof E(e).getConfig("hoverClass")) {
            ...
            !0 === t ? (i(e, "mousemove", function(r, o) {
                ...
                0 === r.buttons && v(e.children, E(e).getConfig("items")).forEach(function(e) {
                    var t, n;
        ...
        var n = e;
        return !0 === E(t).getConfig("copy") && (l(n = e.cloneNode(!0), "aria-copied", "true"),
    ...
    var B = function(e) {
        ...
        l(r, "draggable", "true"),
        h(e, !0),
        !1 === t.disableIEFix) && ("function" == typeof (document || window.document).createElement("span").dragDrop && i(r, "mousedown", function() {
            if (-1 !== n.indexOf(this))
                this.dragDrop();
            else {
    ...
    function U(e, h) {
        ...
        /serialize/.test(a) ? e.map(function(e) {
            var t = d(e, "opts");
            ...
            ["connectWith", "disableIEFix"].forEach(function(e) {
                Object.prototype.hasOwnProperty.call(h, e) && null !== h[e] && console.warn('HTML5Sortable: You are using the deprecated configuration "' + e + '". This will be removed in an upcoming version, make sure to migrate to the new options when updating.')
            }),
            ...
            s.isSortable = !0,
            k(s);
            var e, t = v(s.children, h.items);
            if (null !== h.placeholder && void 0 !== h.placeholder) {
                var n = document.createElement(s.tagName);
                h.placeholder instanceof HTMLElement ? n.appendChild(h.placeholder) : n.innerHTML = h.placeholder,
                e = n.children[0]
            }
            ...
            i(s, "dragstart", function(e) {
                var t = p(e);
                if (!0 !== t.isSortable && (e.stopImmediatePropagation(),
                (!h.handle || t.matches(h.handle)) && "false" !== t.getAttribute("draggable"))) {
                    var n = R(t, e)
                      , r = X(n, t);
                    ...
                    n.dispatchEvent(new CustomEvent("sortstart",{
                        detail: {
                            origin: {
                                elementIndex: _,
                                index: Y,
            ...
            i(s, "dragenter", function(e) {
                ...
                i(r, "dragleave", function(e) {
                    ...
                    e.currentTarget.contains(t) || (h.dropTargetContainerClass && r.classList.remove(h.dropTargetContainerClass),
                    r.dispatchEvent(new CustomEvent("sortleave",{
                        detail: {
                            origin: {
                                elementIndex: _,
                                index: Y,
            ...
            i(s, "dragend", function(e) {
                if (H) {
                    ...
                    void 0 !== H.oldDisplay && (H.style.display = H.oldDisplay,
                    delete H.oldDisplay);
                    var t = Array.from(y.values()).map(function(e) {
                        return e.placeholder
                    }).filter(function(e) {
                        return e instanceof HTMLElement
                    }).filter(f)[0];
                    t && t.remove(),
                    s.dispatchEvent(new CustomEvent("sortstop",{
                        detail: {
                            origin: {
                                elementIndex: _,
                                index: Y,
                ...
                if (D(s, H.parentElement)) {
                    ...
                    if (t) {
                        ...
                        var n = E(s).placeholder
                          ...
                          , i = b(H, Array.from(H.parentElement.children).filter(function(e) {
                            return e !== n
                        }))
                          , l = b(H, a);
                        h.dropTargetContainerClass && o.classList.remove(h.dropTargetContainerClass),
                        _ === i && S === o || s.dispatchEvent(new CustomEvent("sortupdate",{
                            detail: {
                                origin: {
                                    elementIndex: _,
                                    index: Y,
            ...
            var o = c(function(t, e, n, r) {
                if (H)
                    if (h.forcePlaceholderSize && (E(t).placeholder.style.height = I + "px",
                    ...
                    -1 < Array.from(t.children).indexOf(e)) {
                        ...
                        if (I < o || A < a) {
                            var s = o - I
                              ...
                              , c = w(e).top
                              , f = w(e).left;
                            if (i < l && ("vertical" === h.orientation && r < c || "horizontal" === h.orientation && n < f))
                                return;
                            if (l < i && ("vertical" === h.orientation && c + o - s < r || "horizontal" === h.orientation && f + a - d < n))
                                return
                        }
                        ...
                        Array.from(y.values()).filter(function(e) {
                            return void 0 !== e.placeholder
                        }).forEach(function(e) {
                            e.placeholder !== E(t).placeholder && e.placeholder.remove()
                        })
                    } else {
                        var g = Array.from(y.values()).filter(function(e) {
                            return void 0 !== e.placeholder
                        }).map(function(e) {
                            return e.placeholder
                        });
                        -1 !== g.indexOf(e) || t !== e || v(e.children, h.items).length || (g.forEach(function(e) {
                            return e.remove()
                        }),
              ...
              , r = function(e) {
                ...
                H && D(n, H.parentElement) && "true" !== d(n, "_disabled")) {
                    var r = d(n, "opts");
                    parseInt(r.maxItems) && v(n.children, d(n, "items")).length > parseInt(r.maxItems) && H.parentElement !== n || (e.preventDefault(),
                    e.stopPropagation(),
                    e.dataTransfer.dropEffect = !0 === E(n).getConfig("copy") ? "copy" : "move",
                    o(n, t, e.pageX, e.pageY))
                }
            };
            i(t.concat(s), "dragover", r),
            i(t.concat(s), "dragenter", r)
        }),
        e)
    }
    return U.destroy = function(e) {
        var t, n, r, o;
        n = d(t = e, "opts") || {},
...
!function(t, r) {
    ...
    , function(t, r, e) {
        ...
        t.exports = function(t, r, e, n) {
            var o, i = 3 < arguments.length && void 0 !== n ? n : 0, a = function(t, r, e) {
        ...
        var n, o, i, a = function() {
            function i(t, r) {
                    ...
                    return function(t, r) {
                        ...
                        for (var v = new Array(d), p = 0, l = 0; l < n; l += 1)
                            for (u = 0; u < r.length; u += 1)
                                l < i[u].length && (v[p] = i[u][l],
                                p += 1);
                        for (l = 0; l < o; l += 1)
                            for (u = 0; u < r.length; u += 1)
                                l < a[u].length && (v[p] = a[u][l],
                                p += 1);
                        return v
                    }(o, n)
                };
                    ...
                    if (u < 1) {
                        for (var t = 1; t < 40; t++) {
                            for (var r = S.getRSBlocks(t, f), e = M(), n = 0; n < c.length; n++) {
                                var o = c[n];
                                e.put(o.getMode(), 4),
                                e.put(o.getLength(), m.getLengthInBits(o.getMode(), t)),
                                o.write(e)
                            }
                ...
                h.createSvgTag = function(t, r, e, n) {
                    ...
                    var i, a, u, f = h.getModuleCount() * t + 2 * r, c = "", l = "l" + t + ",0 0," + t + " -" + t + ",0 0,-" + t + "z ";
                    ...
                    c += '<path d="',
                    a = 0; a < h.getModuleCount(); a += 1)
                        for (u = a * t + r,
                        i = 0; i < h.getModuleCount(); i += 1)
                ...
                return h.createASCII = function(t, r) {
                    ...
                    for (var e, n, o, i = h.getModuleCount() * t + 2 * r, a = r, u = i - r, f = Array(t + 1).join("██"), c = Array(t + 1).join("  "), l = "", s = "", g = 0; g < i; g += 1) {
                        for (n = Math.floor((g - a) / t),
                        s = "",
                        e = 0; e < i; e += 1)
                            o = 1,
                            a <= e && e < u && a <= g && g < u && h.isDark(n, Math.floor((e - a) / t)) && (o = 0),
                            s += o ? f : c;
                        for (n = 0; n < t; n += 1)
                            l += s + "\n"
                    }
            ...
            i.createStringToBytes = function(u, f) {
                ...
                return function(t) {
                    for (var r = [], e = 0; e < t.length; e += 1) {
                        ...
                        o < 128 ? r.push(o) : "number" == typeof (n = i[t.charAt(e)]) ? (255 & n) == n ? r.push(n) : (r.push(n >>> 8),
                        r.push(255 & n)) : r.push(a)
                    }
                    return r
                }
            }
            ;
            var r, t, a = 1, u = 2, o = 4, f = 8, w = {
                L: 1,
                M: 0,
                Q: 3,
                H: 2
            }, e = 0, n = 1, c = 2, l = 3, s = 4, g = 5, h = 6, d = 7, m = (r = [[], [6, 18], [6, 22], [6, 26], [6, 30], [6, 34], [6, 22, 38], [6, 24, 42], [6, 26, 46], [6, 28, 50], [6, 30, 54], [6, 32, 58], [6, 34, 62], [6, 26, 46, 66], [6, 26, 48, 70], [6, 26, 50, 74], [6, 30, 54, 78], [6, 30, 56, 82], [6, 30, 58, 86], [6, 34, 62, 90], [6, 28, 50, 72, 94], [6, 26, 50, 74, 98], [6, 30, 54, 78, 102], [6, 28, 54, 80, 106], [6, 32, 58, 84, 110], [6, 30, 58, 86, 114], [6, 34, 62, 90, 118], [6, 26, 50, 74, 98, 122], [6, 30, 54, 78, 102, 126], [6, 26, 52, 78, 104, 130], [6, 30, 56, 82, 108, 134], [6, 34, 60, 86, 112, 138], [6, 30, 58, 86, 114, 142], [6, 34, 62, 90, 118, 146], [6, 30, 54, 78, 102, 126, 150], [6, 24, 50, 76, 102, 128, 154], [6, 28, 54, 80, 106, 132, 158], [6, 32, 58, 84, 110, 136, 162], [6, 26, 54, 82, 110, 138, 166], [6, 30, 58, 86, 114, 142, 170]],
                ...
                var n = t
                  ...
                  , i = function(t) {
                    ...
                    for (s += 1; s < d.length; ) {
                        ...
                        s += 1,
                        o.contains(g + h) ? g += h : (l.write(o.indexOf(g), n),
                        o.size() < 4095 && (o.size() == 1 << n && (n += 1),
                        o.add(g + h)),
                        g = h)
                    }
                    return l.write(o.indexOf(g), n),
                    l.write(e, n),
                    l.flush(),
                    c.toByteArray()
                }
            ...
            var B, C, S = (B = [[1, 26, 19], [1, 26, 16], [1, 26, 13], [1, 26, 9], [1, 44, 34], [1, 44, 28], [1, 44, 22], [1, 44, 16], [1, 70, 55], [1, 70, 44], [2, 35, 17], [2, 35, 13], [1, 100, 80], [2, 50, 32], [2, 50, 24], [4, 25, 9], [1, 134, 108], [2, 67, 43], [2, 33, 15, 2, 34, 16], [2, 33, 11, 2, 34, 12], [2, 86, 68], [4, 43, 27], [4, 43, 19], [4, 43, 15], [2, 98, 78], [4, 49, 31], [2, 32, 14, 4, 33, 15], [4, 39, 13, 1, 40, 14], [2, 121, 97], [2, 60, 38, 2, 61, 39], [4, 40, 18, 2, 41, 19], [4, 40, 14, 2, 41, 15], [2, 146, 116], [3, 58, 36, 2, 59, 37], [4, 36, 16, 4, 37, 17], [4, 36, 12, 4, 37, 13], [2, 86, 68, 2, 87, 69], [4, 69, 43, 1, 70, 44], [6, 43, 19, 2, 44, 20], [6, 43, 15, 2, 44, 16], [4, 101, 81], [1, 80, 50, 4, 81, 51], [4, 50, 22, 4, 51, 23], [3, 36, 12, 8, 37, 13], [2, 116, 92, 2, 117, 93], [6, 58, 36, 2, 59, 37], [4, 46, 20, 6, 47, 21], [7, 42, 14, 4, 43, 15], [4, 133, 107], [8, 59, 37, 1, 60, 38], [8, 44, 20, 4, 45, 21], [12, 33, 11, 4, 34, 12], [3, 145, 115, 1, 146, 116], [4, 64, 40, 5, 65, 41], [11, 36, 16, 5, 37, 17], [11, 36, 12, 5, 37, 13], [5, 109, 87, 1, 110, 88], [5, 65, 41, 5, 66, 42], [5, 54, 24, 7, 55, 25], [11, 36, 12, 7, 37, 13], [5, 122, 98, 1, 123, 99], [7, 73, 45, 3, 74, 46], [15, 43, 19, 2, 44, 20], [3, 45, 15, 13, 46, 16], [1, 135, 107, 5, 136, 108], [10, 74, 46, 1, 75, 47], [1, 50, 22, 15, 51, 23], [2, 42, 14, 17, 43, 15], [5, 150, 120, 1, 151, 121], [9, 69, 43, 4, 70, 44], [17, 50, 22, 1, 51, 23], [2, 42, 14, 19, 43, 15], [3, 141, 113, 4, 142, 114], [3, 70, 44, 11, 71, 45], [17, 47, 21, 4, 48, 22], [9, 39, 13, 16, 40, 14], [3, 135, 107, 5, 136, 108], [3, 67, 41, 13, 68, 42], [15, 54, 24, 5, 55, 25], [15, 43, 15, 10, 44, 16], [4, 144, 116, 4, 145, 117], [17, 68, 42], [17, 50, 22, 6, 51, 23], [19, 46, 16, 6, 47, 17], [2, 139, 111, 7, 140, 112], [17, 74, 46], [7, 54, 24, 16, 55, 25], [34, 37, 13], [4, 151, 121, 5, 152, 122], [4, 75, 47, 14, 76, 48], [11, 54, 24, 14, 55, 25], [16, 45, 15, 14, 46, 16], [6, 147, 117, 4, 148, 118], [6, 73, 45, 14, 74, 46], [11, 54, 24, 16, 55, 25], [30, 46, 16, 2, 47, 17], [8, 132, 106, 4, 133, 107], [8, 75, 47, 13, 76, 48], [7, 54, 24, 22, 55, 25], [22, 45, 15, 13, 46, 16], [10, 142, 114, 2, 143, 115], [19, 74, 46, 4, 75, 47], [28, 50, 22, 6, 51, 23], [33, 46, 16, 4, 47, 17], [8, 152, 122, 4, 153, 123], [22, 73, 45, 3, 74, 46], [8, 53, 23, 26, 54, 24], [12, 45, 15, 28, 46, 16], [3, 147, 117, 10, 148, 118], [3, 73, 45, 23, 74, 46], [4, 54, 24, 31, 55, 25], [11, 45, 15, 31, 46, 16], [7, 146, 116, 7, 147, 117], [21, 73, 45, 7, 74, 46], [1, 53, 23, 37, 54, 24], [19, 45, 15, 26, 46, 16], [5, 145, 115, 10, 146, 116], [19, 75, 47, 10, 76, 48], [15, 54, 24, 25, 55, 25], [23, 45, 15, 25, 46, 16], [13, 145, 115, 3, 146, 116], [2, 74, 46, 29, 75, 47], [42, 54, 24, 1, 55, 25], [23, 45, 15, 28, 46, 16], [17, 145, 115], [10, 74, 46, 23, 75, 47], [10, 54, 24, 35, 55, 25], [19, 45, 15, 35, 46, 16], [17, 145, 115, 1, 146, 116], [14, 74, 46, 21, 75, 47], [29, 54, 24, 19, 55, 25], [11, 45, 15, 46, 46, 16], [13, 145, 115, 6, 146, 116], [14, 74, 46, 23, 75, 47], [44, 54, 24, 7, 55, 25], [59, 46, 16, 1, 47, 17], [12, 151, 121, 7, 152, 122], [12, 75, 47, 26, 76, 48], [39, 54, 24, 14, 55, 25], [22, 45, 15, 41, 46, 16], [6, 151, 121, 14, 152, 122], [6, 75, 47, 34, 76, 48], [46, 54, 24, 10, 55, 25], [2, 45, 15, 64, 46, 16], [17, 152, 122, 4, 153, 123], [29, 74, 46, 14, 75, 47], [49, 54, 24, 10, 55, 25], [24, 45, 15, 46, 46, 16], [4, 152, 122, 18, 153, 123], [13, 74, 46, 32, 75, 47], [48, 54, 24, 14, 55, 25], [42, 45, 15, 32, 46, 16], [20, 147, 117, 4, 148, 118], [40, 75, 47, 7, 76, 48], [43, 54, 24, 22, 55, 25], [10, 45, 15, 67, 46, 16], [19, 148, 118, 6, 149, 119], [18, 75, 47, 31, 76, 48], [34, 54, 24, 34, 55, 25], [20, 45, 15, 61, 46, 16]],
    ...
    , function(t, r, e) {
        ...
        function a(t, r, e) {
            var n, o;
            n = r,
            (o = e).back && (n.fillStyle = o.back,
            n.fillRect(0, 0, o.size, o.size)),
            function(t, r, e) {
                if (t) {
    ...
    , function(t, r) {
        ...
        t.exports = {
            ...
            canvas_to_img: function(t) {
                ...
                return r.style.width = t.style.width,
    ...
    , function(t, r) {
        t.exports = function(t, r, e, n, o, i) {
            var a, u, f, c, l, s, g, h, d, v, p, y, w, m, b, x, k, B, C, S, M = i * n, A = o * n, L = M + n, D = A + n, _ = .005 * e.rounded * n, z = t.is_dark, P = o - 1, T = o + 1, j = i - 1, I = i + 1, O = z(o, i), R = z(P, j), F = z(P, i), H = z(P, I), N = z(o, I), E = z(T, I), Y = z(T, i), q = z(T, j), U = z(o, j), W = (a = r,
            {
                m: function(t, r) {
                    return a.moveTo(t, r),
                    this
            ...
            k ? p.l(y, w + x).a(y, w, m, w, x) : p.l(y, w)) : (u = W,
            f = M,
            c = A,
            l = L,
            s = D,
            ...
            d = Y && N && E,
            v = Y && U && q,
            F && U && R && u.m(f + g, c).l(f, c).l(f, c + g).a(f, c, f + g, c, g),
            h && u.m(l - g, c).l(l, c).l(l, c + g).a(l, c, l - g, c, g),
            d && u.m(l - g, s).l(l, s).l(l, s - g).a(l, s, l - g, s, g),
            v && u.m(f + g, s).l(f, s).l(f, s - g).a(f, s, f + g, s, g))
        }
    }
    , function(t, r) {
    ...
    , function(t, r, y) {
        function J(n) {
            ...
            return {
                m: function(t, r) {
                    return n.p += "M ".concat(i(t), " ").concat(i(r), " "),
                    this
                },
                l: function(t, r) {
                    return n.p += "L ".concat(i(t), " ").concat(i(r), " "),
                    this
                },
                a: function(t, r, e) {
                    return n.p += "A ".concat(o(e), " ").concat(o(e), " 0 0 1 ").concat(i(t), " ").concat(i(r), " "),
                    this
                }
            }
        }
        var e = y(5)
          ...
          , b = e.create_svg_el;
        t.exports = function(t, r) {
            var e, n, o, i, a, u, f, c, l, s, g, h, d = r.size, v = r.mode, p = b("svg", {
                xmlns: w,
                width: d,
                height: d,
                viewBox: "0 0 ".concat(d, " ").concat(d)
            });
            return p.style.width = "".concat(d, "px"),
            p.style.height = "".concat(d, "px"),
            r.back && p.appendChild(b("rect", {
                x: 0,
                y: 0,
                width: d,
                height: d,
                ...
                d: function(t, r) {
                    ...
                    for (var i, a, u, f, c, l, s, g, h, d, v, p, y, w, m, b, x, k, B, C, S, M, A, L, D, _, z, P, T, j, I, O, R, F, H, N, E, Y, q, U, W, X, V, G = J(e), Q = 0; Q < n; Q += 1)
                        for (var $ = 0; $ < n; $ += 1)
                            ...
                            S ? m.l(b, x + C).a(b + C, x, C) : m.l(b, x)) : (l = a,
                            s = D,
                            g = _,
                            h = z,
                            d = P,
                            ...
                            y = W && q && U,
                            w = W && V && X,
                            E && V && N && l.m(s + v, g).l(s, g).l(s, g + v).a(s + v, g, v),
                            p && l.m(h, g + v).l(h, g).l(h - v, g).a(h, g + v, v),
                            y && l.m(h - v, d).l(h, d).l(h, d - v).a(h - v, d, v),
                            w && l.m(s, d - v).l(s, d).l(s + v, d).a(s, d - v, v));
                    return e.p
                }(t, r),
                fill: r.fill
            })),
...
NeuQuant = function() {
    ...
    , ot = function() {
        for (var e = [], o = new Array(t), f, r, u, i = 0; i < t; i++)
            o[n[i][3]] = i;
        for (f = 0,
        r = 0; r < t; r++)
            u = o[r],
        ...
        t = 0; t < n; t++)
            v[t] = s * ((n * n - t * t) * d / (n * n));
        for (o = i < g ? 3 : i % tt != 0 ? 3 * tt : i % nt != 0 ? 3 * nt : i % rt != 0 ? 3 * rt : 3 * it,
        t = 0; t < ut; )
            if (k = (a[f + 0] & 255) << r,
            b = (a[f + 1] & 255) << r,
            p = (a[f + 2] & 255) << r,
...
GIFEncoder = function() {
    ...
    for (var c = 0, w = {}; c < 256; c++)
        w[c] = String.fromCharCode(c);
    h.prototype.getData = function() {
        for (var t = "", i = this.bin.length, n = 0; n < i; n++)
            t += w[this.bin[n]];
        return t
    }
    ,
    ...
    h.prototype.writeBytes = function(n, t, i) {
        for (var u = i || n.length, r = t || 0; r < u; r++)
            this.writeByte(n[r])
    }
    ;
    ...
    , kt = t.addFrame = function(t, i) {
        ...
        var r = !0;
        try {
            i ? a = t : (a = t.getImageData(0, 0, t.canvas.width, t.canvas.height).data,
    ...
    , ht = function() {
        ...
        for (l = [],
        f = new NeuQuant(i,e,it),
        r = f.process(),
        n = 0,
        t = 0; t < o; t++)
            u = f.map(i[n++] & 255, i[n++] & 255, i[n++] & 255),
            ut[u] = !0,
            l[t] = u;
        i = null,
        rt = 8,
        ...
        u(o),
        u(s),
        e ? n.writeByte(0) : n.writeByte(128 | p)
    }, vt = function() {
        u(o),
        u(s),
        n.writeByte(240 | p),
...
function RecordRTC(o, r) {
    ...
    r = new RecordRTCConfiguration(o,r = r || {
        type: "video"
    });
    var n = this;
    function t(e) {
        e && (r.initCallback = function() {
            e(),
            e = r.initCallback = null
        }
        );
        var t = new GetRecorderType(o,r);
        (u = new t(o,r)).record(),
        c("recording"),
        r.disableLogs || console.log("Initialized recorderType:", u.constructor.name, "for output-type:", r.type)
    }
    function a(i) {
        if (i = i || function() {}
        ,
        ...
        function e(e) {
            if (u) {
                ...
                if (o && !r.disableLogs && console.log(o.type, "->", bytesToSize(o.size)),
                i) {
                    try {
                ...
                r.autoWriteToDisk && s(function(e) {
                    var t = {};
                    t[r.type + "Blob"] = e,
                    DiskStorage.Store(t)
                })
            } else
                "function" == typeof i.call ? i.call(n, "") : i("")
        }
    }
    function d(e) {
    ...
    function s(t, e) {
        ...
        var o, i = (e || u || {}).blob;
        if (!i)
            return r.disableLogs || console.warn("Blob encoder did not finish its job yet."),
            void setTimeout(function() {
                s(t, e)
            }, 1e3);
        "undefined" == typeof Worker || navigator.mozGetUserMedia ? ((o = new FileReader).readAsDataURL(i),
        o.onload = function(e) {
            t(e.target.result)
        }
        ) : ((o = function(e) {
    ...
    function i(e) {
        e = e || 0,
        "paused" !== n.state ? "stopped" !== n.state && (e >= n.recordingDuration ? a(n.onRecordingStopped) : (e += 1e3,
        setTimeout(function() {
            i(e)
    ...
    function c(e) {
        n && (n.state = e,
        "function" == typeof n.onStateChanged.call ? n.onStateChanged.call(n, e) : n.onStateChanged(e))
    }
    var u, e = 'It seems that recorder is destroyed or "startRecording" is not invoked for ' + r.type + " recorder.";
    function l() {
        !0 !== r.disableLogs && console.warn(e)
    }
    var f, m = {
        startRecording: function(e) {
            return r.disableLogs || console.log("RecordRTC version: ", n.version),
            e && (r = new RecordRTCConfiguration(o,e)),
            r.disableLogs || console.log("started recording " + r.type + " stream."),
            u ? (u.clearRecordedData(),
            u.record(),
            c("recording"),
            n.recordingDuration && i()) : t(function() {
        ...
        pauseRecording: function() {
            u ? "recording" === n.state ? (c("paused"),
            u.pause(),
            r.disableLogs || console.log("Paused recording.")) : r.disableLogs || console.warn("Unable to pause the recording. Recording state: ", n.state) : l()
        },
        resumeRecording: function() {
            u ? "paused" === n.state ? (c("recording"),
            u.resume(),
            r.disableLogs || console.log("Resumed recording.")) : r.disableLogs || console.warn("Unable to resume the recording. Recording state: ", n.state) : l()
        },
        initRecorder: t,
        ...
        clearRecordedData: function() {
            u ? (u.clearRecordedData(),
            r.disableLogs || console.log("Cleared old recorded data.")) : l()
        },
        getBlob: function() {
            if (u)
                return u.blob;
        ...
        toURL: function() {
            if (u)
                return URL.createObjectURL(u.blob);
            l()
        },
        ...
        buffer: null,
        reset: function() {
            "recording" !== n.state || r.disableLogs || console.warn("Stop an active recorder."),
...
function RecordRTCConfiguration(e, t) {
    ...
    t.recorderType && !t.type && (t.recorderType === WhammyRecorder || t.recorderType === CanvasRecorder || void 0 !== WebAssemblyRecorder && t.recorderType === WebAssemblyRecorder ? t.type = "video" : t.recorderType === GifRecorder ? t.type = "gif" : t.recorderType === StereoAudioRecorder ? t.type = "audio" : t.recorderType === MediaStreamRecorder && (getTracks(e, "audio").length && getTracks(e, "video").length || !getTracks(e, "audio").length && getTracks(e, "video").length ? t.type = "video" : getTracks(e, "audio").length && !getTracks(e, "video").length && (t.type = "audio"))),
...
function MRecordRTC(a) {
    ...
    this.startRecording = function() {
        var e, t, o, i, r = this.mediaType, n = this.mimeType || {
            audio: null,
            video: null,
            gif: null
        };
        if ("function" != typeof r.audio && isMediaRecorderCompatible() && !getTracks(a, "audio").length && (r.audio = !1),
        ...
        i = a,
        isMediaRecorderCompatible() && r.audio && "function" == typeof r.audio && (t = getTracks(a, "video")[0],
        isFirefox ? ((i = new MediaStream).addTrack(t),
        e && e === WhammyRecorder && (e = MediaStreamRecorder)) : (i = new MediaStream).addTrack(t)),
        ...
        r.audio && r.video && (o = this,
        i = !0 === isMediaRecorderCompatible(),
        (r.audio instanceof StereoAudioRecorder && r.video || !0 !== r.audio && !0 !== r.video && r.audio !== r.video) && (i = !1),
        !0 === i ? (o.audioRecorder = null,
        o.videoRecorder.startRecording()) : o.videoRecorder.initRecorder(function() {
            o.audioRecorder.initRecorder(function() {
                o.videoRecorder.startRecording(),
                o.audioRecorder.startRecording()
            })
        })),
        r.gif && (e = null,
        "function" == typeof r.gif && (e = r.gif),
        this.gifRecorder = new RecordRTC(a,{
            type: "gif",
    ...
    this.getDataURL = function(o) {
        function i(e, t) {
            var o;
            "undefined" != typeof Worker ? ((o = function(e) {
                var t, o = URL.createObjectURL(new Blob([e.toString(), "this.onmessage =  function (eee) {" + e.name + "(eee.data);}"],{
                    type: "application/javascript"
                })), e = new Worker(o);
                if (void 0 !== URL)
                    t = URL;
            ...
            ,
            o.postMessage(e)) : ((o = new FileReader).readAsDataURL(e),
            o.onload = function(e) {
                t(e.target.result)
            }
            )
...
RecordRTC.getFromDisk = function(o, i) {
    ...
    DiskStorage.Fetch(function(e, t) {
        "all" !== o && t === o + "Blob" && i && i(e),
        "all" === o && i && i(e, t.replace("Blob", ""))
    })
}
,
RecordRTC.writeToDisk = function(e) {
    console.log("Writing recorded blob(s) to disk!"),
    (e = e || {}).audio && e.video && e.gif ? e.audio.getDataURL(function(o) {
...
var lastTime, requestAnimationFrame = window.requestAnimationFrame;
...
function invokeSaveAsDialog(e, t) {
    ...
    var o, i = (e.type || "video/webm").split("/")[1];
    -1 !== i.indexOf(";") && (i = i.split(";")[0]),
    t && -1 !== t.indexOf(".") && (t = (o = t.split("."))[0],
    i = o[1]);
    ...
    if (void 0 !== navigator.msSaveBlob)
        return navigator.msSaveBlob(e, t);
    ...
    "function" == typeof i.click ? i.click() : (i.target = "_blank",
...
function isMediaRecorderCompatible() {
    ...
    var e, t = navigator.userAgent, o = "" + parseFloat(navigator.appVersion), i = parseInt(navigator.appVersion, 10);
    return (isChrome || isOpera) && (e = t.indexOf("Chrome"),
    o = t.substring(e + 7)),
...
function MediaStreamRecorder(o, i) {
    ...
    "audio" === (i = i || {
        mimeType: "video/webm"
    }).type && (getTracks(o, "video").length && getTracks(o, "audio").length && (navigator.mozGetUserMedia ? (e = new MediaStream).addTrack(getTracks(o, "audio")[0]) : e = new MediaStream(getTracks(o, "audio")),
    o = e),
    ...
    var n, a = [];
    function d() {
        r.timestamps.push((new Date).getTime()),
        "function" == typeof i.onTimeStamp && i.onTimeStamp(r.timestamps[r.timestamps.length - 1], r.timestamps)
    }
    function s(e) {
    ...
    this.record = function() {
        ...
        "function" == typeof MediaRecorder.isTypeSupported && t.mimeType && (MediaRecorder.isTypeSupported(t.mimeType) || (i.disableLogs || console.warn("MediaRecorder API seems unable to record mimeType:", t.mimeType),
        t.mimeType = "audio" === i.type ? "audio/webm" : "video/webm"));
        try {
            n = new MediaRecorder(o,t),
        ...
        n.ondataavailable = function(e) {
            ...
            "number" != typeof i.timeSlice ? !e.data || !e.data.size || e.data.size < 100 || r.blob ? r.recordingCallback && (r.recordingCallback(new Blob([],{
                type: s(t)
            })),
            r.recordingCallback = null) : (r.blob = i.getNativeBlob ? e.data : new Blob([e.data],{
                type: s(t)
            }),
            r.recordingCallback && (r.recordingCallback(r.blob),
            r.recordingCallback = null)) : e.data && e.data.size && (a.push(e.data),
            d(),
            "function" == typeof i.ondataavailable && (e = i.getNativeBlob ? e.data : new Blob([e.data],{
                type: s(t)
            }),
            i.ondataavailable(e)))
        }
    ...
    this.stop = function(e) {
        ...
        ,
        r.manuallyStopped = !0,
        n && (this.recordingCallback = e,
        "recording" === n.state && n.stop(),
        "number" == typeof i.timeSlice && setTimeout(function() {
            r.blob = new Blob(a,{
                type: s(i)
            }),
        ...
        if (n && !1 !== i.checkForInactiveTracks)
            return !1 === function() {
                if ("active"in o) {
                    if (!o.active)
                        return !1
                } else if ("ended"in o && o.ended)
                    return !1;
                return !0
            }() ? (i.disableLogs || console.log("MediaStream seems stopped."),
            void r.stop()) : void setTimeout(e, 1e3)
    }(),
...
function StereoAudioRecorder(e, i) {
    ...
    var r, n = this, a = [], d = [], s = !1, c = 0, u = 2, l = (i = i || {}).desiredSampRate;
    function f() {
        if (!1 === i.checkForInactiveTracks)
            return !0;
        if ("active"in e) {
            if (!e.active)
                return !1
    ...
    function t(e, t) {
        function o(e, t) {
            var o, i = e.numberOfAudioChannels, r = e.leftBuffers.slice(0), n = e.rightBuffers.slice(0), a = e.sampleRate, d = e.internalInterleavedLength, e = e.desiredSampRate;
            function s(e, t, o) {
            ...
            e && (a = e),
            2 === i && (o = function(e, t) {
                for (var o = e.length + t.length, i = new Float64Array(o), r = 0, n = 0; n < o; )
                    i[n++] = e[r],
                    i[n++] = t[r],
                    r++;
                return i
            ...
            for (var f = n, m = 44, h = 0; h < f; h++)
                l.setInt16(m, 32767 * o[h], !0),
                m += 2;
            if (t)
                return t({
                    buffer: r,
        ...
        r)).onmessage = function(e) {
            ...
            URL.revokeObjectURL(i.workerURL),
            i.terminate()
        }
        ,
        i.postMessage(e))
    ...
    if (-1 === h.indexOf(g) && (i.disableLogs || console.log("Legal values for buffer-size are " + JSON.stringify(h, null, "\t"))),
    o.createJavaScriptNode)
        r = o.createJavaScriptNode(g, u, u);
    else {
        if (!o.createScriptProcessor)
            throw "WebAudio API has no support on this browser.";
        r = o.createScriptProcessor(g, u, u)
    }
    m.connect(r),
    i.bufferSize || (g = r.bufferSize);
    var p = void 0 !== i.sampleRate ? i.sampleRate : o.sampleRate || 44100;
    (p < 22050 || 96e3 < p) && (i.disableLogs || console.log("sample-rate must be under range 22050 and 96000.")),
    i.disableLogs || i.desiredSampRate && console.log("Desired sample-rate: " + i.desiredSampRate);
    var v = !1;
    function b() {
        a = [],
        c = 0,
    ...
    this.resume = function() {
        if (!1 === f())
            throw "Please make sure MediaStream is active.";
        if (!s)
            return i.disableLogs || console.log("Seems recording has been restarted."),
            void this.record();
        v = !1
    }
    ,
    ...
    r.onaudioprocess = function(e) {
        var t, o;
        v || (!1 === f() && (i.disableLogs || console.log("MediaStream seems stopped."),
        r.disconnect(),
        s = !1),
        s ? (w || (w = !0,
        ...
        a.push(t),
        2 === u && (o = e.inputBuffer.getChannelData(1),
        o = new Float32Array(o),
        d.push(o)),
        c += g,
        n.recordingLength = c,
        void 0 !== i.timeSlice && (y.recordingLength += g,
        y.left.push(t),
        2 === u && y.right.push(o))) : m && (m.disconnect(),
        m = null))
    }
    ,
    ...
    function S() {
        s && "function" == typeof i.ondataavailable && void 0 !== i.timeSlice && (y.left.length ? (t({
            desiredSampRate: l,
            sampleRate: p,
            numberOfAudioChannels: u,
            internalInterleavedLength: y.recordingLength,
            leftBuffers: y.left,
            rightBuffers: 1 === u ? [] : y.right
        }, function(e, t) {
            t = new Blob([t],{
                type: "audio/wav"
            });
...
function CanvasRecorder(r, n) {
    ...
    var o, a, d, e = !(!window.webkitRTCPeerConnection && !window.webkitGetUserMedia || !window.chrome), t = 50, s = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./);
    if (e && s && s[2] && (t = parseInt(s[2], 10)),
    e && t < 52 && (i = !1),
    n.useWhammyRecorder && (i = !1),
    i)
        if (n.disableLogs || console.log("Your browser supports both MediRecorder API and canvas.captureStream!"),
        ...
        navigator.mozGetUserMedia && (n.disableLogs || console.error("Canvas recording is NOT supported in Firefox."));
    this.record = function() {
        if (d = !0,
        i && !n.useWhammyRecorder) {
            var e;
            ...
            try {
                ...
                t.addTrack(getTracks(e, "video")[0]),
                e = t
            } catch (e) {}
            if (!e)
    ...
    this.getWebPImages = function(e) {
        var i;
        "canvas" === r.nodeName.toLowerCase() && (i = m.frames.length,
        m.frames.forEach(function(e, t) {
            var o = i - t;
            n.disableLogs || console.log(o + "/" + i + " frames remaining"),
            n.onEncodingCallback && n.onEncodingCallback(o, i);
    ...
    var c = !(this.stop = function(t) {
        d = !1;
        var o = this;
        i && a ? a.stop(t) : this.getWebPImages(function() {
            m.compile(function(e) {
                n.disableLogs || console.log("Recording finished!"),
                o.blob = e,
                o.blob.forEach && (o.blob = new Blob([],{
                    type: "video/webm"
                })),
                t && t(o.blob),
                m.frames = []
    ...
    function l() {
        ...
        if ("canvas" === r.nodeName.toLowerCase()) {
            ...
            return f = (new Date).getTime(),
            m.frames.push({
                image: (t = document.createElement("canvas"),
                o = t.getContext("2d"),
                t.width = r.width,
                t.height = r.height,
                o.drawImage(r, 0, 0),
        ...
        html2canvas(r, {
            ...
            onrendered: function(e) {
                ...
                if (!t)
                    return setTimeout(l, n.frameInterval);
                f = (new Date).getTime(),
                m.frames.push({
                    image: e.toDataURL("image/webp", 1),
                    duration: t
                }),
                d && setTimeout(l, n.frameInterval)
            }
        })
    }
    this.pause = function() {
    ...
    this.resume = function() {
        c = !1,
        a instanceof MediaStreamRecorder ? a.resume() : d || this.record()
    }
    ,
    this.clearRecordedData = function() {
        d && this.stop(u),
...
function WhammyRecorder(e, i) {
    function o(e) {
        ...
        return t ? a ? (s = (new Date).getTime(),
        setTimeout(o, 100)) : (s = (new Date).getTime(),
        d.paused && d.play(),
        u.drawImage(d, 0, 0, w.width, w.height),
        c.frames.push({
            duration: t,
            image: w.toDataURL("image/webp")
        }),
        void (n || setTimeout(o, e, e))) : setTimeout(o, e, e)
    }
    function r(o, e, t, i, r) {
        var n = document.createElement("canvas");
        n.width = w.width,
        n.height = w.height;
        var a, d, s, u = n.getContext("2d"), l = [], f = -1 === e, c = e && 0 < e && e <= o.length ? e : o.length, m = 0, h = 0, g = 0, p = Math.sqrt(Math.pow(255, 2) + Math.pow(255, 2) + Math.pow(255, 2)), v = t && 0 <= t && t <= 1 ? t : 0, b = i && 0 <= i && i <= 1 ? i : 0, R = !1;
        d = -1,
        s = (a = {
            length: c,
            functionToLoop: function(e, t) {
                ...
                var a, d, s, c;
                R ? n() : ((c = new Image).onload = function() {
            ...
            callback: function() {
                (l = l.concat(o.slice(c))).length <= 0 && l.push(o[o.length - 1]),
                r(l)
            }
        }).length,
        function e() {
    ...
    (i = i || {}).frameInterval || (i.frameInterval = 10),
    i.disableLogs || console.log("Using frames-interval:", i.frameInterval);
    var n = !(this.record = function() {
        ...
        u = w.getContext("2d"),
        i.video && i.video instanceof HTMLVideoElement ? (d = i.video.cloneNode(),
        i.initCallback && i.initCallback()) : (d = document.createElement("video"),
        setSrcObject(e, d),
        ...
        s = (new Date).getTime(),
        c = new Whammy.Video,
        i.disableLogs || (console.log("canvas resolutions", w.width, "*", w.height),
        console.log("video width/height", d.width || w.width, "*", d.height || w.height)),
        o(i.frameInterval)
    }
    )
    ...
    ;
    var d, s, c, w = document.createElement("canvas"), u = w.getContext("2d")
}
...
var Whammy = function() {
    ...
    function i(e) {
        ...
        function l(e) {
            ...
            for (var o = 0; o < e.length; o += 8)
                t.push(parseInt(e.substr(o, 8), 2));
        ...
        function a(e) {
            for (var t = 0, o = {}; t < e.length; ) {
                var i = e.substr(t, 4)
                  , r = (n = t,
                parseInt(e.substr(n + 4, 4).split("").map(function(e) {
                ...
                t += 8 + r,
                o[i] = o[i] || [],
                "RIFF" === i || "LIST" === i ? o[i].push(a(n)) : o[i].push(n)
            }
            return o
        }
        e = new function(e) {
            var t = function(e) {
                ...
                for (var t = e[0].width, o = e[0].height, i = e[0].duration, r = 1; r < e.length; r++)
                    i += e[r].duration;
                return {
                    duration: i,
                    width: t,
            ...
            for (var o, i = [{
                ...
                data: [{
                    ...
                    data: [{
                        ...
                        data: (o = t.duration,
                        [].slice.call(new Uint8Array(new Float64Array([o]).buffer), 0).map(function(e) {
            ...
            return function e(t) {
                ...
                for (var i = 0; i < t.length; i++) {
                    ...
                    "number" == typeof r && (r = l(r.toString(2))),
        ...
        (e.map(function(e) {
            var t = function(e) {
                for (var t = e.RIFF[0].WEBP[0], o = t.indexOf("*"), i = 0, r = []; i < 4; i++)
                    r[i] = t.charCodeAt(o + 3 + i);
                return {
    ...
    e.prototype.compile = function(t) {
        var e, o, e = (e = i,
        o = URL.createObjectURL(new Blob([e.toString(), "this.onmessage =  function (eee) {" + e.name + "(eee.data);}"],{
            type: "application/javascript"
        })),
        e = new Worker(o),
...
var DiskStorage = {
    init: function() {
        ...
        "undefined" != typeof indexedDB && void 0 !== indexedDB.open ? (e = this.dbName || location.href.replace(/\/|:|#|%|\.|\[|\]/g, ""),
        (t = indexedDB.open(e, 1)).onerror = i.onError,
        t.onsuccess = function() {
            (o = t.result).onerror = i.onError,
            o.setVersion && 1 !== o.version ? o.setVersion(1).onsuccess = function() {
                r(o),
                n()
            }
            : n()
...
function GifRecorder(e, o) {
    ...
    this.record = function() {
        "undefined" != typeof GIFEncoder ? t ? (i || (o.width || (o.width = d.offsetWidth || 320),
        ...
        u = requestAnimationFrame(function e(t) {
            if (!0 !== l.clearedRecordedData) {
                ...
                t - s < 90 || (!i && d.paused && d.play(),
                i || a.drawImage(d, 0, 0, n.width, n.height),
                o.onGifPreview && o.onGifPreview(n.toDataURL("image/png")),
                c.addFrame(a),
                s = t)
            }
        }),
        o.initCallback && o.initCallback()) : setTimeout(l.record, 100) : setTimeout(l.record, 1e3)
    }
    ;
    var r = !(this.stop = function(e) {
        ...
        Date.now(),
        this.blob = new Blob([new Uint8Array(c.stream().bin)],{
            type: "image/gif"
        }),
        e(this.blob),
        c.stream().bin = []
    ...
    var n = document.createElement("canvas")
      , a = n.getContext("2d");
    i && (e instanceof CanvasRenderingContext2D ? n = (a = e).canvas : e instanceof HTMLCanvasElement && (a = e.getContext("2d"),
    n = e));
    var d, t = !0;
    i || ((d = document.createElement("video")).muted = !0,
    d.autoplay = !0,
    d.playsInline = !0,
    t = !1,
    d.onloadedmetadata = function() {
    ...
    setSrcObject(e, d),
    d.play());
    var s, c, u = null, l = this
}
function MultiStreamsMixer(i, r) {
    e = "undefined" != typeof global ? global : null,
    void 0 === RecordRTC && e && "undefined" == typeof window && "undefined" != typeof global && (global.navigator = {
    ...
    void 0 === e && ("undefined" != typeof webkitAudioContext && (e = webkitAudioContext),
    "undefined" != typeof mozAudioContext && (e = mozAudioContext));
    var t = window.URL;
    ...
    void 0 !== u && void 0 === u.prototype.stop && (u.prototype.stop = function() {
        this.getTracks().forEach(function(e) {
            e.stop()
        })
    }
    ...
    function l() {
        ...
        n.forEach(function(e) {
            e.stream || (e.stream = {}),
            e.stream.fullcanvas ? t = e : o.push(e)
        }),
        t ? (d.width = t.stream.width,
        d.height = t.stream.height) : o.length ? (d.width = 1 < e ? 2 * o[0].width : o[0].width,
        e = 9 !== e && 10 !== e ? 7 !== e && 8 !== e ? 5 !== e && 6 !== e ? 3 !== e && 4 !== e ? 1 : 2 : 3 : 4 : 5,
        d.height = o[0].height * e) : (d.width = c.width || 360,
        d.height = c.height || 240),
    ...
    function m(e) {
        var t, o, i = document.createElement("video");
        return t = e,
    ...
    this.appendStreams = function(e) {
        ...
        e.forEach(function(e) {
            ...
            n.push(t),
            o.addTrack(e.getTracks().filter(function(e) {
                return "video" === e.kind
            })[0])),
            e.getTracks().filter(function(e) {
                return "audio" === e.kind
            }).length && (e = c.audioContext.createMediaStreamSource(e),
            c.audioDestination = c.audioContext.createMediaStreamDestination(),
            e.connect(c.audioDestination),
            o.addTrack(c.audioDestination.stream.getTracks().filter(function(e) {
                return "audio" === e.kind
            })[0])),
            i.push(o)
        })
    ...
    this.releaseStreams = function() {
        n = [],
        a = !0,
        c.gainNode && (c.gainNode.disconnect(),
        c.gainNode = null),
        c.audioSources.length && (c.audioSources.forEach(function(e) {
            e.disconnect()
        }),
        c.audioSources = []),
        c.audioDestination && (c.audioDestination.disconnect(),
        c.audioDestination = null),
        c.audioContext && c.audioContext.close(),
        c.audioContext = null,
        s.clearRect(0, 0, d.width, d.height),
        d.stream && (d.stream.stop(),
        d.stream = null)
    }
    ,
    ...
    this.getMixedStream = function() {
        ...
        var t = function() {
            var e;
            h(),
            "captureStream"in d ? e = d.captureStream() : "mozCaptureStream"in d ? e = d.mozCaptureStream() : c.disableLogs || console.error("Upgrade to latest Chrome or otherwise enable this flag: chrome://flags/#enable-experimental-web-platform-features");
            var t = new u;
          ...
          , e = function() {
            ...
            c.audioContext = o.AudioContextConstructor,
            c.audioSources = [],
            !0 === c.useGainNode && (c.gainNode = c.audioContext.createGain(),
            c.gainNode.connect(c.audioContext.destination),
            ...
            return i.forEach(function(e) {
                ...
                !0 === c.useGainNode && e.connect(c.gainNode),
                c.audioSources.push(e))
            }),
            t ? (c.audioDestination = c.audioContext.createMediaStreamDestination(),
            c.audioSources.forEach(function(e) {
                e.connect(c.audioDestination)
            }),
            c.audioDestination.stream) : void 0
        }();
...
function MultiStreamRecorder(o, i) {
    ...
    }).frameInterval || (i.frameInterval = 10),
    i.video || (i.video = {}),
    ...
    this.record = function() {
        ...
        t.length && (r.frameInterval = i.frameInterval || 10,
        r.width = i.video.width || 360,
        r.height = i.video.height || 240,
        ...
        return new Promise(function(t, o) {
            try {
                i.recordRTC.stopRecording(function(e) {
                    ...
                    i.blob && i.blob.size ? t(e) : o("Empty blob.", i.blob)
                })
            } catch (e) {
                o(e)
            }
...
function WebAssemblyRecorder(o, d) {
    ...
    function n(t, e) {
        ...
        !d.workerPath && e instanceof ArrayBuffer && (e = new Blob([e],{
            type: "text/javascript"
        }),
        d.workerPath = URL.createObjectURL(e)),
        ...
        i.addEventListener("message", function(e) {
            "READY" === e.data ? (i.postMessage({
                width: d.width,
                height: d.height,
                bitrate: d.bitrate || 1200,
                timebaseDen: d.frameRate || 30,
                realtime: d.realtime
            }),
            new ReadableStream({
                start: function(i) {
                    ...
                    n.onplaying = function() {
                        ...
                        var e = r.getContext("2d")
                          ...
                          , o = setInterval(function() {
                            if (s && (clearInterval(o),
                            i.close()),
                            a && (a = !1,
                            d.onVideoProcessStarted && d.onVideoProcessStarted()),
                            e.drawImage(n, 0, 0),
                            "closed" !== i._controlledReadableStream.state)
                                try {
    ...
    this.record = function() {
        ...
        this.blob = null,
        n(o),
        "function" == typeof d.initCallback && d.initCallback()
    }
    ,
    this.pause = function() {
        r = !0
    ...
    this.stop = function(e) {
        ...
        ,
        i ? (i.addEventListener("message", function(e) {
            null === e.data && (i.terminate(),
            i = null,
            t && t())
        }),
        i.postMessage(null)) : t && t()
    }
    ,
